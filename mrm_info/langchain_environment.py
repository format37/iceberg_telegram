...
class ChatAgent:
    ...
    def initialize_agent(self):
        ...
        mrm_logs_tool = StructuredTool.from_function(
                ...
                name="Логи мастера",
                description="Получает последнее сообщение из логов по имени мастера. Вам следует предоставить master_name извлеченный из chat_history и reply_to_message_id в качестве параметров.",
